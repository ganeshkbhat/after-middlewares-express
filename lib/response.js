...
res.send = function send(body, afterSend) {
  ...
  if (!!afterSend || typeof afterSend === "function") ((afterSend, response) => { afterSend(response, flatten(arguments.slice(2, arguments.length))); })(afterSend, this, flatten(arguments.slice(2, arguments.length)));
